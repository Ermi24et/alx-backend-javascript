...
describe('calculateNumber', () => {
  ...
  describe('SUM first round', () => {
    it('should return 7', () => {
      chai.expect(calculateNumber('SUM', 3.4, 4)).to.equal(7);
    });
  });
  describe('SUM second round', () => {
    it('should return 7', () => {
      chai.expect(calculateNumber('SUM', 5, 2.4)).to.equal(7);
    });
  });
  describe('SUM both round', () => {
    it('should return 7', () => {
      chai.expect(calculateNumber('SUM', 2.4, 4.5)).to.equal(7);
    });
  });
  describe('SUBTRACT no round', () => {
    it('should return 3', () => {
      chai.expect(calculateNumber('SUBTRACT', 5, 2)).to.equal(3);
    });
  });
  describe('SUBTRACT first round', () => {
    it('should return -4', () => {
      chai.expect(calculateNumber('SUBTRACT', 2, 5.5)).to.equal(-4);
    });
  });
  describe('SUBTRACT second round', () => {
    it('should return 2', () => {
      chai.expect(calculateNumber('SUBTRACT', 4.5, 3)).to.equal(2);
    });
  });
  describe('SUBTRACT both round', () => {
    it('should return -3', () => {
      chai.expect(calculateNumber('SUBTRACT', 2.4, 4.5)).to.equal(-3);
    });
  });
  ...
  describe('DIVIDE second round', () => {
    it('should return 0.2', () => {
      chai.expect(calculateNumber('DIVIDE', 2, 4.5)).to.equal(0.4);
    });
  });
  describe('DIVIDE both round', () => {
    it('should return 0.2', () => {
      chai.expect(calculateNumber('DIVIDE', 1.2, 4.5)).to.equal(0.2);
    });
  });
